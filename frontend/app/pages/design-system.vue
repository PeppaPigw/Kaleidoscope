 ...
 */
import { Search, Download, Filter, Star, BookOpen, Sparkles } from 'lucide-vue-next'
...
const demoSubQuestions = [
  { id: 'rq-1', text: 'How does attention scaling affect performance?', status: 'active' as const },
  { id: 'rq-2', text: 'Is the improvement consistent across model sizes?', status: 'answered' as const },
  { id: 'rq-3', text: 'What is the computational overhead?', status: 'parked' as const },
]
  ...
  <div class="ds-page">
    ...
    <div class="ds-content">
      ...
      <section class="ds-section">
        ...
        <p class="ks-type-lead ds-desc">Three variants × three sizes, with loading and disabled states.</p>
        ...
        <div class="ds-grid ds-grid--buttons">
          ...
          <div class="ds-row">
            ...
            <KsButton variant="secondary" :loading="true" size="sm">Saving</KsButton>
          </div>
        </div>
      </section>
      ...
      <section class="ds-section">
        ...
        <p class="ks-type-lead ds-desc">Editorial card surface with accent top variants.</p>

        <div class="ds-grid ds-grid--cards">
          <KsCard>
            <h3 class="ks-type-label">Default Card</h3>
            <p class="ks-type-body-sm">Hovers with a subtle lift and shadow. The foundation for every content surface in Kaleidoscope.</p>
          </KsCard>

          <KsCard variant="teal-top">
            <h3 class="ks-type-label">Teal Top</h3>
            <p class="ks-type-body-sm">Used for primary research intent cards and active workspace elements.</p>
          </KsCard>

          <KsCard variant="gold-top">
            <h3 class="ks-type-label">Gold Top</h3>
            <p class="ks-type-body-sm">Used for highlighted insights, trending topics, and editorial picks.</p>
          </KsCard>

          <KsCard variant="flat" :static="true">
            <h3 class="ks-type-label">Flat + Static</h3>
            <p class="ks-type-body-sm">No border, no hover lift. For nested card contexts where elevation isn't needed.</p>
          </KsCard>
          ...
          <KsCard padding="lg">
            ...
            <p class="ks-type-body-sm">This card has header and footer slots with divider lines.</p>
            <template #footer>
      ...
      <section class="ds-section">
        ...
        <p class="ks-type-lead ds-desc">Small label badges for metadata, with interactive and removable modes.</p>
      ...
      <section class="ds-section">
        ...
        <p class="ks-type-lead ds-desc">Warm-toned loading placeholders — no spinners for content areas.</p>

        <div class="ds-grid ds-grid--skeletons">
          <div>
            <span class="ks-type-eyebrow" style="margin-bottom: 8px; display: block;">Line</span>
            <KsSkeleton variant="line" />
          </div>

          <div>
            <span class="ks-type-eyebrow" style="margin-bottom: 8px; display: block;">Circle</span>
            <KsSkeleton variant="circle" />
          </div>

          <div>
            <span class="ks-type-eyebrow" style="margin-bottom: 8px; display: block;">Paragraph (4 lines)</span>
            <KsSkeleton variant="paragraph" />
          </div>

          <div>
            <span class="ks-type-eyebrow" style="margin-bottom: 8px; display: block;">Card</span>
            <KsSkeleton variant="card" />
          </div>

          <div>
            <span class="ks-type-eyebrow" style="margin-bottom: 8px; display: block;">Custom (200×80)</span>
      ...
      <section class="ds-section">
        ...
        <div class="ds-editorial">
          ...
          <div class="ds-subsection">
            ...
            <KsDropCap>
              Language models have fundamentally changed how we approach natural language processing. The transformer architecture, introduced in 2017, enabled unprecedented parallelization and attention mechanisms that capture long-range dependencies with remarkable efficiency.
            </KsDropCap>
          </div>
          ...
          <div class="ds-subsection">
            ...
            <KsPullQuote>
              "The most profound impact of large language models may not be in their answers, but in the new questions they enable researchers to ask."
          ...
          <div class="ds-subsection" style="position: relative;">
            ...
            <p class="ks-type-body" style="max-width: 55ch;">
              Recent work in multi-modal foundation models has extended the transformer paradigm beyond text to images, audio, and structured data. This cross-modal transfer learning opens fascinating directions for scientific discovery.
            </p>
            <KsMarginNote label="AI Note">
              This summary was generated by GPT-4o with 94% confidence from the paper's abstract and introduction.
            </KsMarginNote>
          </div>
        </div>
      </section>
      ...
      <section class="ds-section">
        ...
        <p class="ks-type-lead ds-desc">Sticky running page header (the one at the top of this page is a live example).</p>

        <KsCard padding="none" :static="true">
          <KsPageHeader title="Paper Profile" section="Papers" :heading-level="2">
      ...
      <section class="ds-section">
        ...
        <div class="ds-grid ds-grid--states">
          <div>
            <span class="ks-type-eyebrow" style="margin-bottom: 12px; display: block;">KsErrorAlert</span>
            <KsErrorAlert message="Failed to fetch paper metadata from CrossRef." :retryable="true" />
          </div>

          <div>
            <span class="ks-type-eyebrow" style="margin-bottom: 12px; display: block;">KsEmptyState</span>
            <KsCard :static="true">
              <KsEmptyState
              ...
              >
                <template #action>
                  <KsButton variant="secondary" size="sm">Clear Filters</KsButton>
                </template>
              </KsEmptyState>
            </KsCard>
          </div>
      ...
      <section class="ds-section">
        ...
        <div class="ds-grid ds-grid--cross">
          ...
          <div>
            <span class="ks-type-eyebrow" style="margin-bottom: 12px; display: block;">KsResearchIntent</span>
            <KsResearchIntent
          ...
          <!-- Evidence Card -->
          <div>
            <span class="ks-type-eyebrow" style="margin-bottom: 12px; display: block;">KsEvidenceCard</span>
            <KsEvidenceCard
          ...
          <!-- Draft Target -->
          <div>
            <span class="ks-type-eyebrow" style="margin-bottom: 12px; display: block;">KsDraftTarget</span>
            <KsDraftTarget
            ...
            <div style="margin-top: 8px; text-align: center;">
              <KsButton variant="ghost" size="sm" @click="draftActive = !draftActive">
                Toggle Active State
              </KsButton>
            </div>
          </div>
      ...
      <section class="ds-section">
        ...
        <p class="ks-type-lead ds-desc">Global slide-out drawer for AI field provenance. Click below to open.</p>
        ...
        <KsProvenanceDrawer
          ...
          :provenance="{ source: 'gpt-4o', confidence: 0.94, timestamp: '2026-03-20T14:30:00Z' }"
          :chain="[
            { source: 'CrossRef', action: 'Metadata fetch', timestamp: '2026-03-19T10:00:00Z', detail: 'Retrieved DOI, title, authors.' },
            { source: 'GROBID', action: 'PDF parsing', timestamp: '2026-03-19T10:05:00Z', detail: 'Extracted full text and section structure.' },
            { source: 'GPT-4o', action: 'Summary generation', timestamp: '2026-03-20T14:30:00Z', detail: 'Generated abstract summary from introduction + results.' },
          ]"
      ...
      <section class="ds-section">
        ...
        <p class="ks-type-lead ds-desc">Full-viewport-width image container with caption.</p>
        ...
        <KsFullBleed
          ...
          aspect-ratio="16 / 5"
        >
          <template #caption>Figure 1 — Attention patterns in a multi-head transformer (Unsplash demo image)</template>
        </KsFullBleed>
      </section>
    </div>
  </div>
