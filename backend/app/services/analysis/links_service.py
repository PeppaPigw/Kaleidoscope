...
_PROMPT_TEMPLATE = (
    "You are a research assistant. Given a paper title, return ONLY a valid JSON object "
    ...
    "code_url (the official code repository URL), "
    "dataset_urls (array of dataset URLs used or released by this paper), "
    "model_weights_url (URL to model weights or checkpoints), "
    "project_page_url (the official project page URL), "
...
class LinksService:
    ...
    async def fetch_links(self, title: str) -> dict:
        """
        ...
        prompt = _PROMPT_TEMPLATE.format(title=title.replace('"', "'"))
        payload = {
        ...
        return {
            ...
            "project_page_url": data.get("project_page_url") or None,
            "related_links": {
