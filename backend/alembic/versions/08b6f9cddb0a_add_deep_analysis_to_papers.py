...
def upgrade() -> None:
    ...
    sa.Column('user_id', sa.UUID(), server_default='00000000-0000-0000-0000-000000000001', nullable=False),
    sa.Column('name', sa.String(length=255), nullable=False),
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('color', sa.String(length=7), nullable=True),
    sa.Column('icon', sa.String(length=50), nullable=True),
    sa.Column('is_smart', sa.Boolean(), nullable=False),
    sa.Column('smart_filter', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    ...
    op.create_index(op.f('ix_digests_deleted_at'), 'digests', ['deleted_at'], unique=False)
    ...
    sa.Column('role', sa.Enum('personal', 'member', 'reviewer', 'admin', name='userrole'), nullable=False),
    sa.Column('is_active', sa.Boolean(), nullable=False),
    ...
    sa.Column('markdown_provenance', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    sa.Column('raw_metadata', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    ...
    op.create_index(op.f('ix_saved_searches_collection_id'), 'saved_searches', ['collection_id'], unique=False)
    ...
    op.create_index(op.f('ix_glossary_terms_deleted_at'), 'glossary_terms', ['deleted_at'], unique=False)
    ...
    op.create_index(op.f('ix_knowledge_cards_deleted_at'), 'knowledge_cards', ['deleted_at'], unique=False)
    ...
    op.create_index(op.f('ix_metadata_provenance_paper_id'), 'metadata_provenance', ['paper_id'], unique=False)
    ...
    op.create_table('ragflow_document_mappings',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('paper_id', sa.UUID(), nullable=True),
    sa.Column('collection_id', sa.UUID(), nullable=True),
    ...
    op.create_index(op.f('ix_reading_logs_deleted_at'), 'reading_logs', ['deleted_at'], unique=False)
    ...
    op.create_table('reading_path_cache',
    sa.Column('id', sa.UUID(), server_default=sa.text('gen_random_uuid()'), nullable=False),
    ...
    op.create_index(op.f('ix_reading_path_cache_from_paper_id'), 'reading_path_cache', ['from_paper_id'], unique=False)
    op.create_index(op.f('ix_reading_path_cache_to_paper_id'), 'reading_path_cache', ['to_paper_id'], unique=False)
    ...
    op.create_index(op.f('ix_reproduction_attempts_paper_id'), 'reproduction_attempts', ['paper_id'], unique=False)
    op.create_index(op.f('ix_reproduction_attempts_user_id'), 'reproduction_attempts', ['user_id'], unique=False)
    ...
    op.create_index(op.f('ix_user_corrections_paper_id'), 'user_corrections', ['paper_id'], unique=False)
    op.create_index(op.f('ix_user_corrections_user_id'), 'user_corrections', ['user_id'], unique=False)
    op.create_table('user_reading_status',
    sa.Column('id', sa.UUID(), server_default=sa.text('gen_random_uuid()'), nullable=False),
    sa.Column('user_id', sa.UUID(), server_default='00000000-0000-0000-0000-000000000001', nullable=False),
    sa.Column('paper_id', sa.UUID(), nullable=False),
    sa.Column('status', sa.String(length=20), nullable=False),
    ...
    op.create_index(op.f('ix_user_reading_status_paper_id'), 'user_reading_status', ['paper_id'], unique=False)
    op.create_index(op.f('ix_user_reading_status_user_id'), 'user_reading_status', ['user_id'], unique=False)
    ...
    op.create_index(op.f('ix_evidence_links_deleted_at'), 'evidence_links', ['deleted_at'], unique=False)
